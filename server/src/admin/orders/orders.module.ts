...
import { OrdersController as SellerOrdersConctoller } from 'src/seller/orders/orders.controller';
...
@Module({
  ...
  controllers: [OrdersController, UserOrdersController, SellerOrdersConctoller],
})
